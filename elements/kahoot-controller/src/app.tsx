...
type StoreAction = FRESCO_READY_ACTION |FRESCO_STATE_CHANGED_ACTION |  SET_PIN_ACTION
...
export function App() {
  ...
  const setPin = useCallback((pin: number|  '') => {
  ...
  if (state.pin) {
    return <KahootPlayer pin={state.pin} canSetPin={state.canSetPin} resetPin={resetPin} />
  }
